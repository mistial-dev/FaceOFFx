...
/// <summary>
/// Result of face processing operation
/// </summary>
...
[PublicAPI]
public sealed record ProcessingResult(byte[] ImageData, ProcessingMetadata Metadata);
...
)
{
    ...
    /// </summary>
    /// <value>Target size in bytes, or None if using fixed rate strategy</value>
    public Maybe<int> TargetSize { get; init; } = Maybe<int>.None;
