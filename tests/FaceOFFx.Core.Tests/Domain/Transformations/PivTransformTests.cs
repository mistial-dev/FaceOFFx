...
public class PivTransformTests
{
    ...
    {
        var crop1 = new CropRect { Left = 0.1f, Top = 0.2f, Width = 0.3f, Height = 0.4f };
        var crop2 = new CropRect { Left = 0.1f, Top = 0.2f, Width = 0.3f, Height = 0.4f };
        var crop3 = new CropRect { Left = 0.1f, Top = 0.2f, Width = 0.3f, Height = 0.5f };
