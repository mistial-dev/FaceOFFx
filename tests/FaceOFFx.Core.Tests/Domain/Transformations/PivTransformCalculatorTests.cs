...
{
    /// <summary>
    /// Tests rotation calculation from eye positions.
    /// </summary>
    /// <param name="leftX">Left eye X coordinate.</param>
    /// <param name="leftY">Left eye Y coordinate.</param>
    /// <param name="rightX">Right eye X coordinate.</param>
    /// <param name="rightY">Right eye Y coordinate.</param>
    /// <param name="expectedDegrees">Expected rotation in degrees.</param>
    ...
    /// <summary>
    /// Tests that identical eye positions result in zero rotation.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that extreme angles are clamped to PIV limits.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests scale factor calculation for various dimensions.
    /// </summary>
    /// <param name="width">Image width.</param>
    /// <param name="height">Image height.</param>
    /// <param name="expectedScale">Expected scale factor.</param>
    ...
    public void CalculateScaleFactor_ShouldCalculateCorrectRatio(
        int width,
        int height,
        float expectedScale
    )
    ...
    /// <summary>
    /// Tests that small images can be upscaled to PIV dimensions.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests PIV crop calculation for a centered face.
    /// </summary>
    [Test]
    public void CalculatePivCrop_WithCenteredFace_ShouldCreateValidCrop()
    {
        ...
        var cropRect = PivTransformCalculator.CalculatePivCrop(
            eyeCenter,
            faceBox,
            sourceDimensions
        );
    ...
    /// <summary>
    /// Tests that crops near image edges are clamped to bounds.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that large face crops stay within image bounds.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that zero rotation returns the same point.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that point rotation produces valid coordinates.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that rotating the center point doesn't move it.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that eye center calculation returns the midpoint.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests eye center calculation with identical points.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Integration test verifying all PIV calculations work together.
    /// </summary>
    [Test]
